// Instructions: 
// Augment the existing nifty.utis.str module, without exporting anything globally 
// - Add the single static function 'pad' with the signature: pad(value: string, length: number, char?: string): string  
...
//   - pad should internally call the *alread-defined* method nifty.utils.str.repeat, which has the signature: repeat(value: string, count: number): string
...
(function () {
    ...
    var str = nifty.utils.str;
    var repeat = str.repeat;
